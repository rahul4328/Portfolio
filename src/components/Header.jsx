    ...
    <>
      ...
      <section className='middle' id='home'>
        <div className='left-content'>
          ...
          <p>As a front-end developer proficient in HTML, CSS, JavaScript and React JS. I am eager to learn new technologies, collaborate with a team, and contribute to delivering high-quality products that meet end-user needs. With a strong attention to detail and a focus on delivering engaging user experiences, I am committed to excellence in front-end development.</p>
